...
## 2.67.1+wwfx.1.0.0 (2020-09-15)
[Source](https://github.com/wwfxuk/rez/tree/2.67.1+wwfx.1.0.0) | [Diff](https://github.com/wwfxuk/rez/compare/2.67.1...2.67.1+wwfx.1.0.0)

**Merged**

- [96bea8c3](https://github.com/wwfxuk/rez/compare/2.67.1...96bea8c3) from [linux-setup-xdg-paths](https://github.com/wwfxuk/rez/tree/linux-setup-xdg-paths).
- [7ecf5b77](https://github.com/wwfxuk/rez/compare/2.67.1...7ecf5b77) from [docs/pip-install](https://github.com/wwfxuk/rez/tree/docs/pip-install).
- [09611c0d](https://github.com/wwfxuk/rez/compare/2.67.1...09611c0d) from [feature/suite-re-resolve](https://github.com/wwfxuk/rez/tree/feature/suite-re-resolve).
- [26bdf8b5](https://github.com/wwfxuk/rez/compare/2.67.1...26bdf8b5) from [install-as-production-package](https://github.com/j0yu/bleeding-rez/tree/install-as-production-package).
...
## 2.66.0+wwfx.1.0.0 (2020-08-16)
[Source](https://github.com/wwfxuk/rez/tree/2.66.0+wwfx.1.0.0) | [Diff](https://github.com/wwfxuk/rez/compare/2.66.0...2.66.0+wwfx.1.0.0)

**Merged**

- 5c800d08 from [install-as-production-package](https://github.com/j0yu/bleeding-rez/tree/install-as-production-package)
- 321ee6a5 from [feature/suite-re-resolve](https://github.com/wwfxuk/rez/tree/feature/suite-re-resolve)
- d7a16ddc from [docs/pip-install](https://github.com/wwfxuk/rez/tree/docs/pip-install)
- 290b58cf from [linux-setup-xdg-paths](https://github.com/wwfxuk/rez/tree/linux-setup-xdg-paths)
...
## 2.63.0+wwfx.1.0.1 (2020-08-16)
[Source](https://github.com/wwfxuk/rez/tree/2.63.0+wwfx.1.0.1) | [Diff](https://github.com/wwfxuk/rez/compare/2.63.0+wwfx.1.0.0...2.63.0+wwfx.1.0.1)

### Fixed

- Stop WWFX rebase pipeline from running every minute

## 2.63.0+wwfx.1.0.0 (2020-08-05)
[Source](https://github.com/wwfxuk/rez/tree/2.63.0+wwfx.1.0.0) | [Diff](https://github.com/wwfxuk/rez/compare/2.63.0...2.63.0+wwfx.1.0.0)

**Merged**

- 742889f3 from [wwfx-auto-update](https://github.com/wwfxuk/rez/tree/wwfx-auto-update)
- dbfdff9a from [install-as-production-package](https://github.com/j0yu/bleeding-rez/tree/install-as-production-package)
- 049ba9f2 from [wiki-merge-utils](https://github.com/wwfxuk/rez/tree/wiki-merge-utils)
- 60c04ff2 from [build-sphinx](https://github.com/wwfxuk/rez/tree/build-sphinx)
- 0aa51ac9 from [feature/suite-re-resolve](https://github.com/wwfxuk/rez/tree/feature/suite-re-resolve)
- 29c58850 from [docs/pip-install](https://github.com/wwfxuk/rez/tree/docs/pip-install)
- 4a3c0de6 from [linux-setup-xdg-paths](https://github.com/wwfxuk/rez/tree/linux-setup-xdg-paths)
